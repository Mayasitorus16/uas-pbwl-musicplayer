...
<body>
	...
	<table>
		...
		<div class="col-sm-5">
			<input type="text" name="tracks_name" value="{{ $rows->tracks_name}}" style="background-color: sienna; color: white" class="form-control" id="inputEmail3">
		</div>
		</div>
		...
		<div class="col-sm-5">
			<input type="text" name="tracks_time" value="{{ $rows->tracks_time}}" style="background-color: sienna; color: white" class="form-control" id="inputEmail3">
		</div>
		</div>
