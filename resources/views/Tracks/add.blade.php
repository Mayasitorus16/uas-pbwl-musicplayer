	...
	<h2>Input Data Tracks</h2>
			...
			@csrf
				<table>					
					...
					<div class="col-sm-5">
							<input type="text" name="tracks_name" class=" form-control" id="inputEmail3"style="color: white; background-color: sienna">
					</div>
					</div>
					...
					<div class="col-sm-5">
							<select name="album_id" class="form-control" style="background-color: sienna; color: white">
					...
					<div class="col-sm-5">
							<input type="text" name="tracks_time" class=" form-control" id="inputEmail3"style="color: white; background-color: sienna">
					</div>
					</div>
				...
				<div class="form-group row">
					<div>
						<div class="col-sm-10">
						<button type="submit" class="btn" style="background-color: #ffffff " >SIMPAN</button></div>
					</div>
			</form>
